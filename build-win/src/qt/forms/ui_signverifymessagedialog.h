...
public:
    ...
    void retranslateUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        addressIn_SM->setToolTip(QCoreApplication::translate("SignVerifyMessageDialog", "The Sequentia address to sign the message with", nullptr));
...
#if QT_CONFIG(tooltip)
        signMessageButton_SM->setToolTip(QCoreApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this Sequentia address", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        addressIn_VM->setToolTip(QCoreApplication::translate("SignVerifyMessageDialog", "The Sequentia address the message was signed with", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        verifyMessageButton_VM->setToolTip(QCoreApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified Sequentia address", nullptr));
#endif // QT_CONFIG(tooltip)
