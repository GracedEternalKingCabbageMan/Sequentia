...
public:
    ...
    void setupUi(QDialog *Intro)
    {
        ...
        pruneOptLayout->setObjectName(QString::fromUtf8("pruneOptLayout"));
        ...
        pruneGB->setObjectName(QString::fromUtf8("pruneGB"));

        pruneOptLayout->addWidget(pruneGB);

        lblPruneSuffix = new QLabel(Intro);
        lblPruneSuffix->setObjectName(QString::fromUtf8("lblPruneSuffix"));
