...
public:
    ...
    void retranslateUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        payTo->setToolTip(QCoreApplication::translate("SendCoinsEntry", "The Sequentia address to send the payment to", nullptr));
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        checkboxSubtractFeeFromAmount->setToolTip(QCoreApplication::translate("SendCoinsEntry", "The fee will be deducted from the amount being sent. The recipient will receive less than you enter in the amount field. If multiple recipients are selected, the fee is split equally.", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        messageTextLabel->setToolTip(QCoreApplication::translate("SendCoinsEntry", "A message that was attached to the payment URI which will be stored with the transaction for your reference. Note: This message will not be sent over the Sequentia network.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
