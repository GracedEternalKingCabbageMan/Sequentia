...
public:
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
...
#if QT_CONFIG(tooltip)
        externalSignerPath->setToolTip(QCoreApplication::translate("OptionsDialog", "Full path to a Sequentia Core compatible script (e.g. C:\\Downloads\\hwi.exe or /Users/you/Downloads/hwi.py). Beware: malware can steal your coins!", nullptr));
#endif // QT_CONFIG(tooltip)
        tabWidget->setTabText(tabWidget->indexOf(tabWallet), QCoreApplication::translate("OptionsDialog", "W&allet", nullptr));
#if QT_CONFIG(tooltip)
        mapPortUpnp->setToolTip(QCoreApplication::translate("OptionsDialog", "Automatically open the Sequentia client port on the router. This only works when your router supports UPnP and it is enabled.", nullptr));
#endif // QT_CONFIG(tooltip)
        mapPortUpnp->setText(QCoreApplication::translate("OptionsDialog", "Map port using &UPnP", nullptr));
#if QT_CONFIG(tooltip)
        mapPortNatpmp->setToolTip(QCoreApplication::translate("OptionsDialog", "Automatically open the Sequentia client port on the router. This only works when your router supports NAT-PMP and it is enabled. The external port could be random.", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        connectSocks->setToolTip(QCoreApplication::translate("OptionsDialog", "Connect to the Sequentia network through a SOCKS5 proxy.", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        connectSocksTor->setToolTip(QCoreApplication::translate("OptionsDialog", "Connect to the Sequentia network through a separate SOCKS5 proxy for Tor onion services.", nullptr));
#endif // QT_CONFIG(tooltip)
        ...
        overriddenByCommandLineInfoLabel->setText(QCoreApplication::translate("OptionsDialog", "Options set in this dialog are overridden by the command line or in the configuration file:", nullptr));
