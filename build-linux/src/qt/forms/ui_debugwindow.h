...
#if QT_CONFIG(tooltip)
        peerRelayTxesLabel->setToolTip(QCoreApplication::translate("RPCConsole", "Whether the peer requested us to relay transactions.", nullptr));
#endif // QT_CONFIG(tooltip)
        peerRelayTxesLabel->setText(QCoreApplication::translate("RPCConsole", "Wants Tx Relay", nullptr));
...
#if QT_CONFIG(tooltip)
        peerAddrProcessedLabel->setToolTip(QCoreApplication::translate("RPCConsole", "Total number of addresses processed, excluding those dropped due to rate-limiting.", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        peerAddrRateLimitedLabel->setToolTip(QCoreApplication::translate("RPCConsole", "Total number of addresses dropped due to rate-limiting.", nullptr));
#endif // QT_CONFIG(tooltip)
