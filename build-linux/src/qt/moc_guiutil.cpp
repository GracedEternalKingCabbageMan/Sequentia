...
QT_INIT_METAOBJECT const QMetaObject GUIUtil::LabelOutOfFocusEventFilter::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_GUIUtil__LabelOutOfFocusEventFilter.data,
    qt_meta_data_GUIUtil__LabelOutOfFocusEventFilter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
struct qt_meta_stringdata_GUIUtil__ThemedLabel_t {
    QByteArrayData data[1];
    char stringdata0[21];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_GUIUtil__ThemedLabel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GUIUtil__ThemedLabel_t qt_meta_stringdata_GUIUtil__ThemedLabel = {
    {
QT_MOC_LITERAL(0, 0, 20) // "GUIUtil::ThemedLabel"
...
void GUIUtil::ThemedLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    (void)_o;
    (void)_id;
    (void)_c;
...
QT_INIT_METAOBJECT const QMetaObject GUIUtil::ThemedLabel::staticMetaObject = { {
    QMetaObject::SuperData::link<QLabel::staticMetaObject>(),
    qt_meta_stringdata_GUIUtil__ThemedLabel.data,
    qt_meta_data_GUIUtil__ThemedLabel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *GUIUtil::ThemedLabel::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *GUIUtil::ThemedLabel::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_GUIUtil__ThemedLabel.stringdata0))
        return static_cast<void*>(this);
    return QLabel::qt_metacast(_clname);
}

int GUIUtil::ThemedLabel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
QT_INIT_METAOBJECT const QMetaObject GUIUtil::ClickableLabel::staticMetaObject = { {
    QMetaObject::SuperData::link<ThemedLabel::staticMetaObject>(),
...
void *GUIUtil::ClickableLabel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GUIUtil__ClickableLabel.stringdata0))
        return static_cast<void*>(this);
    return ThemedLabel::qt_metacast(_clname);
}

int GUIUtil::ClickableLabel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = ThemedLabel::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
...
QT_INIT_METAOBJECT const QMetaObject GUIUtil::ClickableProgressBar::staticMetaObject = { {
    QMetaObject::SuperData::link<QProgressBar::staticMetaObject>(),
    qt_meta_stringdata_GUIUtil__ClickableProgressBar.data,
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ItemDelegate *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject GUIUtil::ItemDelegate::staticMetaObject = { {
    QMetaObject::SuperData::link<QItemDelegate::staticMetaObject>(),
    qt_meta_stringdata_GUIUtil__ItemDelegate.data,
    qt_meta_data_GUIUtil__ItemDelegate,
    qt_static_metacall,
    nullptr,
    nullptr
} };
