...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-con_maxblockweight=<n>", "SEQUENTIA: per-chain maximum block weight in BIP141 weight units; 0 uses the global maximum (4000000). Sequentia uses 400000 (a tenth of Bitcoin's, for ~1-minute blocks; whitepaper §3.10). Custom chains only. (default: 0)", ArgsManager::ALLOW_ANY, OptionsCategory::CHAINPARAMS);
